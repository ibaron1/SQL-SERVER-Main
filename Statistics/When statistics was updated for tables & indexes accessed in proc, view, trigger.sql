...
-- Group by dependent object and get when statistics waa updated and space
set nocount on

declare @objname varchar(400)= 'srf_main.GetORCDailyExtract_EOD'
