...
begin
	...
	(DbName,
	 ...
	 set @ArchiveOlderThan = 
	 (select top (1) convert(char(10), dateadd(dd,-1*(RetentionDays),ctrl.DataArchivingStarted),101)
	 ...
	 delete core.loadIdsForDataArchiving

	 insert core.loadIdsForDataArchiving
	 select loadId
