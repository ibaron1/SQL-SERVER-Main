if object_id('tfmarchive.DataArchiveFinalSteps') is not null
  drop proc tfmarchive.DataArchiveFinalSteps
go
...
****************************************************************************************************************/
create proc tfmarchive.DataArchiveFinalSteps
...
from after_del
where  DbSpaceAfterArchiving.DbName = db_name() and AppDataType = @AppDataType