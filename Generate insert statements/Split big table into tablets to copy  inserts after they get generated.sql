...
select * into dbo.EnrichedUTI_copy from dbo.EnrichedUTI

    
select distinct [Trade ID Type] as TradeIdType,[Trade ID] as PublisherTradeID,[UTI Prefix] as UTIPrefix,[UTI Value] as UTI
into dbo.Enriched_SRF_UTI from dbo.EnrichedUTI --378014
