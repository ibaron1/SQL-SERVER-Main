...
rem Data_export_import.SeveralTbls.SourceAndTargetNamesDiff.cmd
...
for /f %%T in (%TblList%) do (bcp_export_import.NamesDiff.cmd %%T %SybaseInstance% %SQLInstance% %passwd% %Db% %bcpDir% %bcpDb%)