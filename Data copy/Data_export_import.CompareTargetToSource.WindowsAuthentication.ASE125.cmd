...
rem Data_export_import.CompareTargetToSource.WindowsAuthentication.ASE125.cmd
...
echo go >> %bcpDir%\tbl.%Db%.sql
isql -Ux171524 -S%SybaseInstance% -P%sybpasswd% -b -i%bcpDir%\tbl.%Db%.sql -o%bcpDir%\tblList.%Db%.txt
