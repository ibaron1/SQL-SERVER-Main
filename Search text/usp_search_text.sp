USE [capax]
GO
/****** Object:  StoredProcedure [dbo].[usp_search_text]    Script Date: 09/20/2011 15:35:48 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
ALTER proc [dbo].[usp_search_text] (@searchfor varchar(100),@db varchar(100) = null,@objname varchar(100)=null)
as
set nocount on
