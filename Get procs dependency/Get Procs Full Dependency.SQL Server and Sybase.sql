...
(select 1 from #t4 where Calling = #t5.Calling and 
 (Called1=#t5.Called1 or Called2=#t5.Called2 or Called3=#t5.Called3))
...
(select 1 from #t5 where Calling = #t6.Calling and 
 (Called1=#t6.Called1 or Called2=#t6.Called2 or Called3=#t6.Called3 or Called4=#t6.Called4))
...
(select 1 from #t6 where Calling = #t7.Calling and 
 (Called1=#t7.Called1 or Called2=#t7.Called2 or Called3=#t7.Called3 or Called4=#t7.Called4 
  or Called5=#t7.Called5))
order by 1,2,3,4,5,6,7,8

select Calling+' ->'+Called1+' ->'+Called2+' ->'+Called3+' ->'+Called4+' ->'+Called5+' ->'+Called6+' ->'+Called7 as CallingChain
into #SPdependency
from #t8
union all
...
select * from #SPdependency

/*
select row#, SP, execSP 
into #whatIsAvailable
from 
(select distinct SUBSTRING(CallingChain,1,CHARINDEX('-',CallingChain)-1) as callingSP
 from #SPdependency) d 
join AnnReportRuns_SPs_converted r
on r.SP = d.callingSP

select * from #whatIsAvailable

select distinct SP from #whatIsAvailable
*/

drop table #t1,#t2,#t3,#t4,#t5, #t6, #t7, #t8
--drop table #SPdependency, #whatIsAvailable
