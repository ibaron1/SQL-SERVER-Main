...
into #indexstats
from sys.dm_db_index_physical_stats(DB_ID('riskbook'), NULL, NULL, NULL, 'DETAILED')
go

use riskbook
go

select dbname, object_name(indexstats.object_id) as [Table], i.name as [Index],
